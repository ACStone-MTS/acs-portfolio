...
This is a portion of the API documentation used when interacting with Casper nodes. I wrote this for use with the Casper protocol, while working with Casper Labs full-time.
...
|---------|----|-----------| 
|block_identifier|Object|The Block hash or the Block height.|
...
|block|Object|The Block, if found. (Not required)|
...
|Parameter|Type|Description|
|---------|----|-----------| 
|block_identifier|Object|The Block hash.|
...
|Parameter|Type|Description|
|---------|----|-----------|
|block_identifier|Object|The Block hash. (Optional)|
...
|---------|----|-----------| 
|api_version|String|The RPC API version.|
|chainspec_bytes|Object|The raw bytes of the chainspec.toml, genesis accounts.toml, and global_state.toml files.|
...
|block_identifier|Object|The Block identifier.|
...
|Parameter|Type|Description|
|---------|----|-----------|
|state_root_hash|String|Hash of the state root.|
|dictionary_identifier|Object|The Dictionary query identifier.|
...
|---------|----|-----------| 
|api_version|String|The RPC API version.|
|available_block_range|Object|The available block range in storage.|
|block_sync|Object|The status of the block synchronizer builders.|
...
|last_progress|String|Timestamp of the last recorded progress in the reactor.|
|next_upgrade|Object|Information about the next scheduled upgrade.|
|our_public_signing_key|String|Our public signing key.|
|peers|Array|The node ID and network address of each connected peer.|
|reactor_state|String|The current state of the node reactor.|
